...
public class VentanaConsultaAlumno extends javax.swing.JFrame {
    ...
    /**
     * Creates new form VentanaConsultaAlumno
     */
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(jrb_num_control);
        ...
        buttonGroup1.add(jrb_mostrar_todo);
    ...
    private void tbl_alumnosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_alumnosMouseClicked
        ...
        txt_nombres.setText(modelo.getValueAt(tbl_alumnos.getSelectedRow(), 2).toString());
